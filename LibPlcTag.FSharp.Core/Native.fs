...
[<DllImport(dllName)>]
extern int plc_tag_set_raw_bytes(int32 id, int offset, byte* buffer, int buffer_length)

[<DllImport(dllName)>]
extern int plc_tag_get_raw_bytes(int32 id, int offset, byte* buffer, int buffer_length)
